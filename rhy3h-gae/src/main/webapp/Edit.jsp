    ...
    <header class="pb-3 mb-4 border-bottom">
      	<div class="d-flex flex-column flex-md-row align-items-center">
			...
			<nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
				<% if (user != null) { %>
				<a class="py-2 text-dark text-decoration-none" href="<%=userService.createLogoutURL("/Edit.jsp") %>" target="_parent"><%=user.getNickname()%>，登出</a>
				<% } else { %>
				<a class="py-2 text-dark text-decoration-none" href="<%=userService.createLoginURL("/Edit.jsp") %>" target="_parent">Anonymous，登入</a>
				<% } %>
			</nav>
		</div>
    </header>
